...
internal class ImmutableIntIdentityIndexedVertexProperty(
...
internal class ImmutableIntIndexedVertexProperty(
    override val graph: ImmutableGraph,
    private val vertices: IndexedVertexSet,
    defaultValueFunction: VertexFunction<Int>,
) : MutableVertexProperty<Int> {

    private val property = IntArray(vertices.size) { index ->
