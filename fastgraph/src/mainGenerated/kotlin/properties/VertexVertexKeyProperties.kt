...
internal class VertexIdentityIndexedVertexKeyProperty(
    override val graph: Graph,
) : MutableVertexKeyProperty<Vertex>, VertexChangeListener {
    ...
    override fun hasVertex(key: Vertex): Boolean {
        checkComplete()
...
internal class VertexIndexedVertexKeyProperty(
    override val graph: Graph,
...
internal class VertexVertexKeyProperty(
    override val graph: Graph,
) : MutableVertexKeyProperty<Vertex>, VertexChangeListener {
