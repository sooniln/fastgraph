...
internal class IntIdentityIndexedEdgeProperty(
...
internal class IntIndexedEdgeProperty(
...
internal class ImmutableIntIdentityIndexedEdgeProperty<G>(
    override val graph: G,
    defaultValueFunction: EdgeFunction<Int>,
) : MutableEdgeProperty<Int> where G : ImmutableGraph, G : IdentityIndexedEdgeGraph {
...
internal class ImmutableIntIndexedEdgeProperty<G>(
    override val graph: G,
    defaultValueFunction: EdgeFunction<Int>,
) : MutableEdgeProperty<Int> where G : ImmutableGraph, G : IndexedEdgeGraph {

    private val property = IntArray(graph.edges.size) { index ->
...
internal class IntEdgeProperty(
...
internal class ImmutableIntEdgeProperty(
