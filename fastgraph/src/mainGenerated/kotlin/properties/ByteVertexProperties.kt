...
internal class ByteIdentityIndexedVertexProperty(
...
internal class ByteIndexedVertexProperty(
...
internal class ImmutableByteIdentityIndexedVertexProperty<G>(
    override val graph: G,
    defaultValueFunction: VertexFunction<Byte>,
) : MutableVertexProperty<Byte> where G : ImmutableGraph, G : IdentityIndexedVertexGraph {
...
internal class ImmutableByteIndexedVertexProperty<G>(
    override val graph: G,
    defaultValueFunction: VertexFunction<Byte>,
...
internal class ByteVertexProperty(
...
internal class ImmutableByteVertexProperty(
