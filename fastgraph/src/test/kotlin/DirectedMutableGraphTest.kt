...
class DirectedMutableGraphTest {
    ...
    fun mutateVertexWithEdges() {
        ...
        edgeProperty[e4] = "e4"
        val e5 = graph.createEdgeReference(graph.addEdge(v1, v3))
        edgeProperty[e5] = "e5"
        val e6 = graph.createEdgeReference(graph.addEdge(v3, v3))
        edgeProperty[e6] = "e6"
    ...
    fun mutateEdge() {
        ...
        val e2 = graph.createEdgeReference(graph.addEdge(v1, v1))
