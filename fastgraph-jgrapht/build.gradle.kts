...
tasks.named("compileJava", JavaCompile::class.java) {
    options.compilerArgumentProviders.add(CommandLineArgumentProvider {
        ...
        listOf("--patch-module", "io.github.sooniln.fastgraph.jgrapht=${sourceSets["main"].output.asPath}")
    })
}
...
mavenPublishing {
    ...
    coordinates(group.toString(), "fastgraph-jgrapht", version.toString())

    pom {
        name = "fastgraph-jgrapht"
        description = "JGraphT adapter for the FastGraph library."
        inceptionYear = "2026"
