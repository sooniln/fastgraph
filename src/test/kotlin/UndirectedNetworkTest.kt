...
class UndirectedNetworkTest {
    ...
    private fun constructGraph(immutable: Boolean) {
        if (immutable) {
            ...
            val n = mutableGraph(false, supportMultiEdge = true)
            graph = n
    ...
    fun outDegree(immutable: Boolean) {
        ...
        context(graph) {
            assertThat(v0.outDegree).isEqualTo(4)
    ...
    fun inDegree(immutable: Boolean) {
        ...
        context(graph) {
            assertThat(v0.inDegree).isEqualTo(4)
    ...
    fun outgoingEdges(immutable: Boolean) {
        ...
        context(graph) {
            assertThat(v0.outgoingEdges()).containsExactlyInAnyOrder(e0, e2, e3, e4)
    ...
    fun incomingEdges(immutable: Boolean) {
        ...
        context(graph) {
            assertThat(v0.incomingEdges()).containsExactlyInAnyOrder(e0, e2, e3, e4)
