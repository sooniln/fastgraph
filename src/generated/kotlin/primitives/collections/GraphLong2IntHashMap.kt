...
import io.github.sooniln.fastcollect.longs.Long2IntMap
...
internal class GraphLong2IntHashMap @JvmOverloads constructor(
    capacity: Int = 0,
    ...
    constructor(map: Long2IntMap) : this() {
        putAll(map)
    }

    constructor(map: Map<Long, Int>) : this() {
        putAll(map)
    }
    ...
    override fun getValue(key: Long): Int =
        findSlot(key, { slot -> valuesArr[slot] as Int }, { throw NoSuchElementException() })

    @Suppress("UNCHECKED_CAST", "USELESS_CAST")
    override fun getOrDefault(key: Long, defaultValue: Int): Int =
    ...
    private inline fun set(key: Long, onAdd: () -> Int, onReplace: (slot: Int) -> Int) {
        require(key != EMPTY_KEY)
    ...
    override fun putAll(from: Long2IntMap) {
        if (from is GraphLong2IntHashMap && from.size / 2 > size) {
    ...
    private fun resetTo(from: GraphLong2IntHashMap) {
        check(!from.isEmpty())
    ...
    override val keys: MutableLongSet
        get() {
            return _keys ?: object : MutableLongSet {
                override val size: Int get() = this@GraphLong2IntHashMap.size
    ...
    private fun setRehashing(keysArr: LongArray, valuesArr: IntArray, mask: Int, key: Long, value: Int) {
    ...
    private open inner class SlotIterator {
        private val keysArr = this@GraphLong2IntHashMap.keysArr
        private val valuesArr = this@GraphLong2IntHashMap.valuesArr
        ...
        fun updateValue(newValue: Int) {
            ...
            if (keysArr !== this@GraphLong2IntHashMap.keysArr) throw ConcurrentModificationException()
    ...
    private inner class FastEntryIterator : SlotIterator(), MutableFastIterator<MutableLong2IntMap.MutableEntry>,
        MutableLong2IntMap.MutableEntry {
