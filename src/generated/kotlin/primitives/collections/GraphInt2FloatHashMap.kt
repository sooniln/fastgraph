...
import io.github.sooniln.fastcollect.ints.IntFloatConsumer
...
@JvmInline
internal value class GraphInt2FloatHashMap private constructor(@PublishedApi internal val map: Int2IntHashMap) : MutableInt2FloatMap {
    ...
    public constructor(map: Int2FloatMap): this() { putAll(map) }
    public constructor(map: Map<Int, Float>): this() { putAll(map) }
    ...
    override fun foreach(action: IntFloatConsumer) = map.foreach { key, value -> action.accept(key, Float.fromBits(value)) }
    ...
    @JvmInline
    public value class Entry(@PublishedApi internal val entry: MutableInt2IntMap.MutableEntry) : MutableInt2FloatMap.MutableEntry {
