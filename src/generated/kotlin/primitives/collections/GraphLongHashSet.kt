...
internal class GraphLongHashSet @JvmOverloads constructor(
    ...
    override fun addAll(elements: LongCollection): Boolean {
        var modified = false
        if (elements is GraphLongHashSet && elements.size / 2 > size) {
    ...
    private fun resetTo(elements: GraphLongHashSet) {
    ...
    private inner class Iterator : MutableLongIterator() {
        private val keysArr = this@GraphLongHashSet.keysArr
        ...
        override fun remove() {
            ...
            if (keysArr !== this@GraphLongHashSet.keysArr) throw ConcurrentModificationException()
